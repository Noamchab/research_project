d3.json("cannes.json").then((df) => {
  ...
  const categories1 = ["Palme d'Or", "Official Selection"];
  ...
  const categories2 = ["Grand Prix", "Official Selection"];
  ...
  const categories3 = ["Jury Prize", "Official Selection"];
  ...
  if (document.getElementById("chart5")) {
    ...
    const categoriesX = ["Palme d'Or", "Official Selection"];
  ...
  if (document.getElementById("chart6")) {
    ...
    const categoriesX = ["Grand Prix", "Official Selection"];
    const comedyLevels = [0, 1, 2];
  ...
  if (document.getElementById("chart7")) {
    ...
    const categoriesX = ["Jury Prize", "Official Selection"];
    const comedyLevels = [0, 1, 2];
