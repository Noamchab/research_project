d3.json("reviews.json").then((df) => {
        ...
        document.getElementById("info1").innerHTML = `
          <div class="info-content">
            ...
            <div class="info-text">
              ...
              Press rating: ${f.tomatoMeter}/100
            </div>
          </div>
        `;
      }
        ...
        document.getElementById("info3").innerHTML = `
          <div class="info-content">
            ...
            <div class="info-text">
              ...
              Genres: ${f.genres}<br>
              Public rating: ${f.audienceScore}/100<br>
              <strong>Press rating:</strong> ${f.tomatoMeter}/100
            </div>
          </div>
        `;
      }
          ...
          document.getElementById("info4").innerHTML = `
            <div class="info-content">
              ...
              <div class="info-text">
                <h2>${f.title}</h2>
                Revenue: ${f.revenue.toLocaleString()} dollars<br>
                <strong>Comedy level:</strong> ${level}<br>
  ...
  if (document.getElementById("chart5")) {
    ...
    svg5
      ...
      .on("click", () => {
        if (lockedPoint) {
          lockedPoint.attr("stroke", "none").attr("r", 3).attr("opacity", 0.15);
          lockedPoint = null;
          document.getElementById("info5").innerText =
            "Hover over a point to view information about an example of a film represented in that bar.";
        }
      });
    ...
    const points = svg5
      ...
      .enter()
      .append("circle")
      .attr("cx", (d) => x5(d.Comedy + (Math.random() - 0.5) * jitter))
      ...
      .on("mouseout", function () {
        ...
        d3.select(this).attr("r", 3).attr("opacity", 0.15);
      })
    ...
    const xMean = d3.mean(df, (d) => d.Comedy);
    const yMean = d3.mean(df, (d) => d.log10_revenue);

    const slope =
      d3.sum(df, (d) => (d.Comedy - xMean) * (d.log10_revenue - yMean)) /
      d3.sum(df, (d) => Math.pow(d.Comedy - xMean, 2));
  ...
  if (document.getElementById("chart6")) {
    ...
    const points = svg6
      ...
      .enter()
      .append("circle")
      .attr("cx", (d) => x6(d.Comedy + (Math.random() - 0.5) * jitter))
    ...
    const slope =
      d3.sum(df, (d) => (d.Comedy - xMean) * (d.audienceScore - yMean)) /
      d3.sum(df, (d) => Math.pow(d.Comedy - xMean, 2));
  ...
  if (document.getElementById("chart7")) {
    ...
    const points = svg7
      ...
      .enter()
      .append("circle")
      .attr("cx", (d) => x7(d.Comedy + (Math.random() - 0.5) * jitter))
